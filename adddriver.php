...
if(isset($_POST['submit'])) { 
	...
	$query="INSERT INTO driver(driverid,drivername,phonenumber,boardingtime,vehicletype,busid,routeid)
	VALUES('$driverid','$drivername','$phonenumber','$boardingtime','$vehicletype','$busid','$routeid')";
...
<form action="adddriver.php" method="post">
  <div class="container">
    ...
    <label for="driverid"><b>DriverID</b></label>
    <input type="number" placeholder="Enter Driverid" name="driverid" required>
	<br>
    <label for="drivername"><b>Driver Name</b></label>
    <input type="text" placeholder="Enter Driver Name" name="drivername" required>
    <br>
    <label for="phonenumber"><b>Phone Number</b></label>
    <input type="number" placeholder="Enter Driver Mobile No" name="phonenumber" required>
	<br>
	<label for="boardingtime"><b>Boarding Time</b></label>
    <input type="time" placeholder="Enter Boardingtime" name="boardingtime" required>
	<br>
