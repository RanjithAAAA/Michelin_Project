...
if(isset($_POST['submit'])) { 
	...
	$routeid=$_POST['routeid'];
		 ...
		 $update="update driver set drivername='".$drivername."',
phonenumber='".$phonenumber."', boardingtime='".$boardingtime."',
vehicletype='".$vehicletype."',busid='".$busid."',routeid='".$routeid."'
 where driverid='".$driverid."'";  
mysqli_query($conn, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br>
<a href='driver.php'>Go to View Updated Record</a>";
...
<form action="" method="post">
  <div class="container">
    ...
    <hr>
    <input name="driverid" type="hidden" value="<?php echo $row['driverid'];?>" />
    
    <label for="drivername"><b>Driver Name</b></label>
    <input type="text" placeholder="Edit Driver Name" name="drivername" value="<?php echo $row['drivername'];?>">
    <br>
    <label for="phonenumber"><b>Phone Number</b></label>
    <input type="number" placeholder="Edit Driver Mobile No" name="phonenumber" value="<?php echo $row['phonenumber'];?>">
	<br>
	<label for="boardingtime"><b>Boarding Time</b></label>
    <input type="time" placeholder="Edit Boardingtime" name="boardingtime" value="<?php echo $row['boardingtime'];?>">
	<br>
	<label for="vehicletype"><b>Vehicle Type</b></label>
    <input type="text" placeholder="Edit" name="vehicletype" value="<?php echo $row['vehicletype'];?>">
	<br>
	<label for="busid"><b>Bus ID</b></label>
    <input type="text" placeholder="Edit Busid" name="busid" value="<?php echo $row['busid'];?>">
	<br>
