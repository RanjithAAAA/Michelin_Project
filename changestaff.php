...
if(isset($_POST['submit'])) { 
	...
	$boardingpoint=$_REQUEST['boardingpoint'];  
   	$boardingtime=$_REQUEST['boardingtime']; 
	$shift=$_REQUEST['shift'];
	$vehicletype=$_REQUEST['vehicletype'];
	$routeid=$_REQUEST['routeid'];
	 
	 $update="update users set username='".$username."',crew='".$crew."',
contactno='".$contactno."', boardingpoint='".$boardingpoint."',
boardingtime='".$boardingtime."',shift='".$shift."',vehicletype='".$vehicletype."',routeid='".$routeid."'
 where userid='".$userid."'";
	mysqli_query($conn, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br>
<a href='staff.php'>Go to View Updated Record</a>";
...
<form action="" method="post">
  <div class="container">
    ...
    <input type="text" placeholder="Edit username" name="username" value="<?php echo $row['username'];?>">
    <br>
	 <label for="crew"><b>Crew</b></label>
    <input type="number" placeholder="Edit Crew" name="crew" value="<?php echo $row['crew'];?>" >
	<br>
    <label for="contactno"><b>Phone Number</b></label>
    <input type="number" placeholder="Edit User Mobile No" name="contactno" value="<?php echo $row['contactno'];?>" >
	<br>
	<label for="boardingpoint"><b>Boarding Point</b></label>
    <input type="text" placeholder="Edit Boardingpoint" name="boardingpoint" value="<?php echo $row['boardingpoint'];?>" >
	<br>
	<label for="boardingtime"><b>Boarding Time</b></label>
    <input type="time"  name="boardingtime" value="<?php echo $row['boardingtime'];?>" >
	<br>
	<label for="shift"><b>Shift</b></label>
    <input type="text" placeholder="Edit Shift" name="shift" value="<?php echo $row['shift'];?>" >
	<br>
	<label for="vehicletype"><b>Vehicle Type</b></label>
    <input type="text" placeholder="Edit A for Van and B for Bus" name="vehicletype" value="<?php echo $row['vehicletype'];?>" >
	<br>
	<label for="routeid"><b>Route ID</b></label>
    <input type="number" placeholder="Edit Route ID" name="routeid" value="<?php echo $row['routeid'];?>">
