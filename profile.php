...
$conn = new mysqli("mtransport-mysqldbserver.mysql.database.azure.com","balaji@mtransport-mysqldbserver","Michelin@1234","michelindb");
 $query = "SELECT * from newlogin where id='".$id."'";
...
if(isset($_POST['submit'])) { 
	...
	$usertype=$_REQUEST['usertype'];  
	 ...
	 $update="update newlogin set username='".$username."',
...
<form action="" method="post">
  <div class="container">
    ...
    <input type="password" placeholder="Edit password" name="password" value="<?php echo $row['password'];?>">
    <br>
	<label for="usertype"><b>User Name</b></label>
    <input type="text" placeholder="Edit usertype" name="usertype" value="<?php echo $row['usertype'];?>">
